...
from constants import (
    BONEAWAREAI_DATA_ACCESS_ROLE,
    BONEAWAREAI_DATA_ACCESS_SESSION,
    BONEAWAREAI_S3_BUCKET,
    DATASETS_FOLDER,
)

>>>>>>> cda79f5e96470a15aca4e433208ba93185123e03
...
def download_file_from_s3(bucket_name, file_key, output_folder):
    ...
    credentials = assume_role(
        BONEAWAREAI_DATA_ACCESS_ROLE, BONEAWAREAI_DATA_ACCESS_SESSION
    )
