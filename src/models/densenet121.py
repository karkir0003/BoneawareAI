...
class DenseNet121(nn.Module):
    def __init__(self, num_classes=1):
        ...
        self.third_block = DenseBlock(24, 256, 32)
        self.third_transition = TransitionLayer(256 + 24 * 32, 512)

        self.fourth_block = DenseBlock(16, 512, 32)

        self.final_layer = nn.Linear(512 + 16 * 32, num_classes)
